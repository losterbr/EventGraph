...
{
    /// <summary>
    /// Enforces the graph-node boundary: concrete types expose no
    ...
    public class NodeArchitectureTests
    {
        ...
        {
            // .editorconfig enforces the *Node suffix in Graph/Nodes;
            // this test prevents them from exposing source capabilities.
