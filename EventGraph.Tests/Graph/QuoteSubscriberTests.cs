    ...
    public class QuoteSubscriberTests
    {
        ...
        public void NodeGraphLoaderResolvesBasketDependenciesRecursively()
        {
            ...
            try
            {
                ...
                File.WriteAllText(Path.Combine(directory, "b.json"), /*lang=json,strict*/ "{\"type\":\"BasketDefinition\",\"name\":\"B\",\"currency\":\"USD\",\"constituents\":[\"A\"],\"weights\":[1.0]}");
                File.WriteAllText(Path.Combine(directory, "c.json"), /*lang=json,strict*/ "{\"type\":\"BasketDefinition\",\"name\":\"C\",\"currency\":\"USD\",\"constituents\":[\"B\"],\"weights\":[1.0]}");
